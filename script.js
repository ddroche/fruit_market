...
$(document).ready(function() {
  ...
  fruitArray.forEach(function(elem) {
    ...
    $div.append($img).append($btnBuy).append($btnSell)
        .append($price).append($avgPrice);
  ...
  var intervalID = setInterval(function() {
    fruitArray.forEach(function(elem) {
      var elemPrice = randomPrice();
      elem.price = elemPrice;
  ...
  $('img[alt="apples"]').next().on('click', function() {
    ...
    $(this).next().next().next()
           .text('Avg. Purchased Price ' + '$' + apples.avgPrice);
  ...
  $('img[alt="oranges"]').next().on('click', function() {
    ...
    $(this).next().next().next()
           .text('Avg. Purchased Price ' + '$' + oranges.avgPrice);
  ...
  $('img[alt="bananas"]').next().on('click', function() {
    ...
    $(this).next().next().next()
           .text('Avg. Purchased Price ' + '$' + bananas.avgPrice);
  ...
  $('img[alt="grapes"]').next().on('click', function() {
    ...
    $(this).next().next().next()
           .text('Avg. Purchased Price ' + '$' + grapes.avgPrice);
